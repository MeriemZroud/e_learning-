...
class TeacherProfileController extends AbstractController
{
    ...
    public function profile(Request $request, EntityManagerInterface $entityManager): Response|RedirectResponse
    {
        ...
        if ($request->isMethod('POST')) {
            if (!$this->isCsrfTokenValid('teacher_profile_update', (string) $request->request->get('_token'))) {
        ...
        return $this->render('dashboard/teacher_profile.html.twig', [
            'user' => $profileUser,
        ]);
    }
